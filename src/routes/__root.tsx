  ...
  head: () => ({
    meta: [
      ...
      { title: "SECRET — Global creator subscriptions" },
      {
        name: "description",
        content:
          "SECRET is a global platform where creators build communities, publish content and earn recurring revenue.",
      },
  ...
  return (
    <html lang="pt-BR" suppressHydrationWarning>
      <head>
        <HeadContent />
        <script
          src="https://cdn.jsdelivr.net/npm/livekit-client@2.21.0/dist/livekit-client.umd.min.js"
          defer
        />
      </head>
      <body>
