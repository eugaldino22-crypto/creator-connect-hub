  ...
  return (
    <Select value={locale} onValueChange={(value) => setLocale(value as Locale)}>
      <SelectTrigger
        ...
        className={compact ? "h-11 w-11 shrink-0 justify-center rounded-full border-white/10 bg-white/[0.04] p-0 sm:h-10 sm:w-10" : "h-10 w-[154px] justify-between rounded-full px-3"}
      >
        ...
        {!compact ? <Globe2 className="size-4 shrink-0" /> : null}
      </SelectTrigger>
