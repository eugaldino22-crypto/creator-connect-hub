...
export function FinanceDashboard() {
  ...
  return <div className="space-y-5">
    <div className="grid gap-3 sm:grid-cols-3">
      <Metric icon={<Wallet className="size-4" />} label="Disponível" value={formatCents(b?.available_cents ?? 0, "USD")} />
      <Metric icon={<Clock3 className="size-4" />} label="Pendente" value={formatCents(b?.pending_cents ?? 0, "USD")} />
